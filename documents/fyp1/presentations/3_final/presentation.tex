...
\begin{frame}{System Architecture & Diagrams}
    ...
    \vspace{0.5cm}
    \begin{itemize}
        \item \href{run:./diagrams/class_structure.pdf}{\beamerbutton{Class Diagram (PDF)}}
        \item \href{run:./diagrams/use_case_diagram.png}{\beamerbutton{Use Case Diagram (PNG)}}
        \item \href{run:./diagrams/sequence_diagram.pdf}{\beamerbutton{Sequence Diagram (PDF)}}
        \item \href{run:./diagrams/swimlane_diagram.pdf}{\beamerbutton{Swimlane Diagram (PDF)}}
        \item \href{run:./diagrams/database_schema.pdf}{\beamerbutton{Database Schema (PDF)}}
    \end{itemize}
\end{frame}
